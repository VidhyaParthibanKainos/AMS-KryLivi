...
public class CreateSecondaryLogEntryLogCountsTestCase extends CommonTestCase {
	...
	private void validateLogCounts(Object debugLogCount, Object infoLogCount, Object warnLogCount, Object errorLogCount, Object fatalLogCount, Object totalLogCount, Object fileLogCount, Object debugExpectedValue, Object infoExpectedValue, Object warnExpectedValue, Object errorExpectedValue, Object fatalExpectedValue, Object totalExpectedValue, Object fileExpectedValue) {
		assertEquals(String.format(MESSAGE_UNEXPECTED_VALUE, PROP_GLOBAL_SECONDARYLOG_COUNT_DEBUG), debugExpectedValue, debugLogCount);
		assertEquals(String.format(MESSAGE_UNEXPECTED_VALUE, PROP_GLOBAL_SECONDARYLOG_COUNT_INFO), infoExpectedValue, infoLogCount);
		assertEquals(String.format(MESSAGE_UNEXPECTED_VALUE, PROP_GLOBAL_SECONDARYLOG_COUNT_WARN), warnExpectedValue, warnLogCount);
		assertEquals(String.format(MESSAGE_UNEXPECTED_VALUE, PROP_GLOBAL_SECONDARYLOG_COUNT_ERROR), errorExpectedValue, errorLogCount);
		assertEquals(String.format(MESSAGE_UNEXPECTED_VALUE, PROP_GLOBAL_SECONDARYLOG_COUNT_FATAL), fatalExpectedValue, fatalLogCount);
		assertEquals(String.format(MESSAGE_UNEXPECTED_VALUE, PROP_GLOBAL_SECONDARYLOG_COUNT_TOTAL), totalExpectedValue, totalLogCount);
		assertEquals(String.format(MESSAGE_UNEXPECTED_VALUE, PROP_GLOBAL_SECONDARYLOG_COUNT_BY_FILE), fileExpectedValue, fileLogCount);
	}
	...
	public Action terminate() throws Exception {
		...
		Object fatalLogCount = ctx.getProperty(PROP_GLOBAL_SECONDARYLOG_COUNT_FATAL);
		...
		assertNotNull(String.format(MESSAGE_UNEXPECTED_NULL, PROP_GLOBAL_SECONDARYLOG_COUNT_FATAL), fatalLogCount);
		...
		assertTrue(String.format(MESSAGE_UNEXPECTED_TYPE, PROP_GLOBAL_SECONDARYLOG_COUNT_FATAL), fatalLogCount instanceof Integer);
