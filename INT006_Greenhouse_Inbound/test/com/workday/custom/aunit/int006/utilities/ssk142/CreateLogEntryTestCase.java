...
public class CreateLogEntryTestCase extends CommonTestCase {
	...
	public void verifyLoggedMessageHTML() throws Exception {
		if ("testHtmlFatalMessage".equalsIgnoreCase(getName())) {
			assertPrimaryCloudLogEntryHTML("FATAL", "Fatal Message", "Fatal Message Detail", "101", "testFatalMessage", "10000", "1", "Details about 10000");
	...
	public void verifyLoggedMessageCSV() throws Exception {
		if ("testCsvFatalMessage".equalsIgnoreCase(getName())) {
			assertPrimaryCloudLogEntryCSV("FATAL", "Fatal Message", "Fatal Message Detail", "101", "testFatalMessage", "10000", "1", "Details about 10000");
